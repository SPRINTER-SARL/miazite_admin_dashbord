...
const Modal = ({
  ...
  centered,
  scrollContent,
  themeClass = "text-primary-500 bgorder-b border-b-gray-100",
  title = "Basic Modal",
  label = "Basic Modal",
  labelClass,
}) => {
          ...
          <div className="fixed inset-0 overflow-y-auto">
            ...
            >
              ...
              >
                ...
                >
                  <div
                    className={`relative overflow-hidden py-4 px-5 text-primary-500 flex justify-between  ${themeClass}`}
                  >
                    <h2 className="capitalize leading-6 tracking-wider font-medium text-base text-primary-500">
                      {title}
                    </h2>
