...
const Navmenu = ({ menus }) => {
  ...
  const isLocationMatch = (targetLocation) => {
    return (
      ...
      locationName
        .toLocaleLowerCase()
        .includes(`${targetLocation.toLocaleLowerCase()}/`)
    );
  };
  ...
  useEffect(() => {
    ...
    document.title = `DANYLPRO  | ${locationName}`;
          ...
          <li
            ...
            className={` single-sidebar-menu 
              ...
              ${
                locationName
                  .toLocaleLowerCase()
                  .includes(item.link.toLocaleLowerCase())
                  ? "menu-item-active"
                  : ""
              }`}
          >
            ...
            {!item.child && !item.isHeadr && (
              <NavLink className="menu-link" to={item.link} onClick={() => {}}>
